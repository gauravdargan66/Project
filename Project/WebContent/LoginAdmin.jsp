			...
			<div class="row align-items-center justify-content-between d-flex">
				...
				<nav id="nav-menu-container">
					<ul class="nav-menu">
						...
						<li class="menu-active"><a href="LogIn.jsp">Log In</a>
						</li> 
...
<!-- 					<p>In the history of modern astronomy, there is probably no one greater leap forward than the building and launch of
	...
	<!-- Start About Area -->
	<section class="about-area section-gap" id="foc" >
			...
			<div class="row align-items-center justify-content-center">
				...
				<div class="offset-lg-1 col-lg-6 offset-md-0 col-md-12 about-right">
					...
					<div class="wow fadeIn" data-wow-duration="1s">
						<form action="AdminServlet" method="post" class="form-box d-flex justify-content-between" style="max-width:none ; width :defualt ">
							<ul>
                            <li style="margin-bottom:10px;"> <h4> Enter Username </h4></li>                           
                            <li><input type="text" placeholder="Enter Username" class="form-control" name="username" style="width:300px;"></li><br>
                            <li style="margin-bottom:10px;"> <h4> Enter Password </h4></li>
                            <li><input type="password" placeholder="Enter Password" class="form-control" name="password" style="width:300px;"></li><br>
							<li><button type="submit" class="btn search-btn" style="width:300px; margin-bottom:20px;" >Log In As Admin</button></li>
                            </ul>
						</form>
                        <p> <a href="LogIn.jsp">Log In As Student</a> <a href="index.jsp" style="margin-left:40px;"> Not a Member yet ? </a> </p>
					<!--</div>
