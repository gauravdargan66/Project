			...
			<div class="row align-items-center justify-content-center">
				...
				<div class="offset-lg-1 col-lg-6 offset-md-0 col-md-12 about-right">
					...
					<div class="wow fadeIn" data-wow-duration="1s">
						<form action="LoginServlet" method="post" class="form-box d-flex justify-content-between" style="max-width:none ; width :defualt ">
							<ul>
                            <li style="margin-bottom:10px;"> <h4> Enter Email </h4></li>                           
                            <li><input type="email" placeholder="Enter E-Mail" class="form-control" name="email" style="width:300px;"></li><br>
							...
							<li><button type="submit" class="btn search-btn" style="width:300px; margin-bottom:20px;" >Log In As Student</button></li>
                            </ul>
						</form>
                        <p> <a href="LoginAdmin.jsp">Log In As Admin</a> <a href="index.jsp" style="margin-left:40px;"> Not a Member yet ? </a> </p>
					<!--</div>
