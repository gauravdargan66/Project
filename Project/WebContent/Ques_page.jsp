...
<!-- <script type="text/javascript">
	$(document).ready(function (){
		 $.post('questionsServlet',{"question": question1},
		            function() { // on success
		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p>Hurry Up!!! , Time is going On.......</p>
					<div class="link-nav">
						<span class="box">
							<a href="Log_Index.jsp">Home </a>
							<i class="lnr lnr-arrow-right"></i>
							<a href="Instruct.jsp">Instructions For Quiz</a>
                            <i class="lnr lnr-arrow-right"></i>
                            <a href="#">Test Started</a>
						</span>
					</div>
				</div>
			</div>
	...
	<section class="faculty-area section-gap">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-8">
					<div class="section-title text-center" style="padding-bottom: 35px;">
						<h2> Online Quiz Test :</h2> <hr>
						
						<center><div id="quiz-time-left" style="width:50%;padding:10px;background-color:#283367; border-radius:10px; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19); color:white;"></div></center> 
						<script type="text/javascript">
							...
							function CheckTime()
							{
								document.getElementById("quiz-time-left").innerHTML='Time Left:'
								+c_minutes+' minutes '+c_seconds+' seconds';
								if(total_seconds<=0){
					...
					<form action="Result" method="post" id="f">
									...
									try {
										    if (request.getAttribute("piList") != null) {
										        ArrayList itemsArray1 = (ArrayList) request.getAttribute("piList");
										        ArrayList itemsArray = null;
										        String ques=null;
										        String sol=null;
										        char c = 'a';
										        String ans = null; 
										        ...
										        {
										        	itemsArray = (ArrayList) itemsArray1.get(j);
									...
									<p style="text-align:justify;"><b>
										<% out.println(j+1+".  </b> "+itemsArray.get(i));
										ques=(String) itemsArray.get(i);
										%>
										<input type="hidden" value="<%=ques%>" name="ques<%=j%>">
									</p>
									...
									%>
										<p style="text-align:justify;">
											<%ans = (String) itemsArray.get(i); %>
											<input type="radio" value="<%=ans%>" name="name<%=j%>"  > &nbsp;<% out.println(c+")  "); %> <%  out.println(itemsArray.get(i)); %>
									...
									<% 
										        	...
										        	{	
										        		sol=(String) itemsArray.get(i);
										        %>
														
														<input type="hidden" value="<%=sol%>" name="sol<%=j %>">
														<% 	
										        	}
...
%>
							...
							<center><button type="submit" id="button" class="primary-btn">Submit</button></center>
							</form>
...
<!-- 	
	<input type="button" id="ajaxcall" onclick="callAjax()">
	<div style="height:30px;">
    </div> -->
...
<!-- 	<script type="text/javascript">
	...
	function callAjax(){
		alert("Akac function called");
		$.post('/Project/questionsServlet',{"question": "question1"},
