			...
			<div class="row fullscreen d-flex align-items-center justify-content-center">
				<div class="banner-content col-lg-8 col-md-12">
					...
					<div class="input-wrap">
						<form action="SignUpDetail" method ="post" class="form-box d-flex justify-content-between" style="max-width:none ; width : 750px ">
					...
					<div class="courses pt-20">
						<a href="LogIn.jsp" data-wow-duration="1s" data-wow-delay=".3s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Quantitative Aptitude 
							</a>
						<a href="LogIn.jsp" data-wow-duration="1s" data-wow-delay=".6s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Logical Reasoning</a>
						<a href="LogIn.jsp" data-wow-duration="1s" data-wow-delay=".9s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Java Programming</a>
						<a href="LogIn.jsp" data-wow-duration="1s" data-wow-delay="1.2s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">C++ Programming
						</a>
						<a href="LogIn.jsp" data-wow-duration="1s" data-wow-delay="1.5s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">C Programming</a>
<!-- 						<a href="LogIn.jsp" data-wow-duration="1s" data-wow-delay="1.8s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">VB.NET	
						</a> -->
						<a href="LogIn.jsp" data-wow-duration="1s" data-wow-delay="2.1s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Python</a>
                        <a href="LogIn.jsp" data-wow-duration="1s" data-wow-delay="2.1s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Random</a>
					</div>
				</div>
			</div>
		</div> 
				...
				<div class="col-lg-4 col-md-6">
					<div class="feature-item">
						...
						<div class="wow fadeIn" data-wow-duration="1s" data-wow-delay=".5s">
							<p>
								C is a general-purpose, procedural computer programming language supporting structured programming, and recursion, while a static type system prevents unintended operations.
							</p>
						</div>
					</div>
				</div>
