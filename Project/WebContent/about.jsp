			...
			<div class="row align-items-center justify-content-between d-flex">
				...
				<nav id="nav-menu-container">
					<ul class="nav-menu">
						...
						<li class="menu-active"><a href="about.jsp">About</a></li>
			...
			<div class="row align-items-center justify-content-center">
				...
				<div class="offset-lg-1 col-lg-6 offset-md-0 col-md-12 about-right">
					...
					<div class="wow fadeIn" data-wow-duration="1s">
						<p>
							<h4>1)&nbsp;We provide Quizes in different categories.<br></h4>
							<h4>2)&nbsp;This Quizes helps you to boost up your knowledge and sharpen your programming skills.<br></h4>
							<h4>3)&nbsp;We also provide Quizes on Quantitative aptitude and quizes on logical reasoning also.<br></h4>
							<h4>4)&nbsp;This will help you in your Placements also.</h4>
						</p>
					</div>
