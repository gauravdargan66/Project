				...
				<div class="about-content col-lg-12">
					...
					<div class="link-nav">
						<span class="box">
							...
							<a href="#call">Instructions For Quiz</a>
						</span>
					</div>
				</div>
			</div>
...
//String userName = (String) session.getAttribute("plno");
	...
	<!-- Start Faculty Area -->
	<section class="faculty-area section-gap" style="padding:100px;" id="call">
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-lg-8">
					<div class="section-title text-center">
						<h2>Instructions :</h2> <hr>
						<b style="color:black;padding-right:400px;">Date: <script> document.write(new Date().getDate()+"/"+(new Date().getMonth()+1)+"/"+new Date().getFullYear()); </script></b>&nbsp;&nbsp;&nbsp;&nbsp;
                       	<b style="color:black;">Points: 10</b><br>
                        <b style="color:black;padding-right:318px">Questions: 10</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <b style="color:black;">Time Limit: 15 min</b><hr>
                        <h5 align="justify" style="margin-bottom:15px;">The quiz consists of 10 multiple-choice questions in all catergories. The quizzes consists of questions carefully designed to help you self-assess your comprehension of the information presented on the topics in the module.</h5>
                        <ol  align="justify" style="margin-left: 80px;">
                            <li><b>I.</b>   &nbsp; Each Question consists of 4 options out of which 1 is correct.</li>
                            <li><b>II.</b> &nbsp;   Each Correct answer will be awarded with 1 point. No negative marking is there.</li>
                            <li><b>III.</b>  &nbsp;  You have to choose only 1 option among the 4 options.</li>
                            <li><b>IV.</b> &nbsp;   15 min timer will automatically starts after click on Start Quiz.</li>
                            <li><b>V.</b>  &nbsp;  To start the quiz you have to click 'Start Quiz' button below.</li>
                            <li><b>VI.</b> &nbsp;   To submit your choices click on the 'Submit' button.</li>
                        </ol>
                        <!--<p>
             ...
             <div style="margin-top:-55px;">
                	<u><center> <h3> Best Of Luck !!! </h3> </center></u>
                </div>
